...
enum PhotoshopE925 {
	...
	PhotoshopE925LighterColor = 'e496',
...
@protocol PhotoshopGenericMethods
...
+ (PhotoshopApplication *) application;

- (SBElementArray<PhotoshopDocument *> *) documents;
- (SBElementArray<PhotoshopFont *> *) fonts;
- (SBElementArray<PhotoshopNotifier *> *) notifiers;
...
@property (copy, readonly) NSArray<NSString *> *macintoshFileTypes;  // list of file image types Photoshop can open
...
@property (copy, readonly) NSArray<NSURL *> *recentFiles;  // files in the recent file list
...
@property (copy, readonly) NSArray<NSString *> *windowsFileTypes;  // list of file image extensions Photoshop can open
...
- (NSArray<NSURL *> *) PhotoshopOpenDialog;  // use the Photoshop open dialog to select files
- (NSString *) batch:(NSString *)x fromFiles:(NSArray<NSURL *> *)fromFiles from:(NSString *)from withOptions:(PhotoshopBatchOptions *)withOptions;  // run the batch automation routine
- (NSString *) createPDFPresentationFromFiles:(NSArray<NSURL *> *)fromFiles toFile:(NSURL *)toFile withOptions:(PhotoshopPresentationOptions *)withOptions;  // create a PDF presentation file
- (NSString *) createContactSheetFromFiles:(NSArray<NSURL *> *)fromFiles withOptions:(PhotoshopContactSheetOptions *)withOptions;  // create a contact sheet from multiple files
...
- (NSString *) createPhotoMergeFromFiles:(NSArray<NSURL *> *)fromFiles;  // DEPRECATED. Merges multiple files into one, user interaction required.
- (NSString *) createPicturePackageFromFiles:(NSArray<NSURL *> *)fromFiles withOptions:(PhotoshopPicturePackageOptions *)withOptions;  // create a picture package from multiple files
...
- (NSString *) doJavascript:(id)x withArguments:(NSArray<id> *)withArguments showDebugger:(PhotoshopE940)showDebugger;  // execute a JavaScript
- (void) pasteClippingToSelection:(BOOL)clippingToSelection;  // paste clipboard into the current document

@end

// A document
@interface PhotoshopDocument : SBObject <PhotoshopGenericMethods>

- (SBElementArray<PhotoshopArtLayer *> *) artLayers;
- (SBElementArray<PhotoshopChannel *> *) channels;
- (SBElementArray<PhotoshopColorSampler *> *) colorSamplers;
- (SBElementArray<PhotoshopCountItem *> *) countItems;
- (SBElementArray<PhotoshopHistoryState *> *) historyStates;
- (SBElementArray<PhotoshopLayerComp *> *) layerComps;
- (SBElementArray<PhotoshopLayer *> *) layers;
- (SBElementArray<PhotoshopLayerSet *> *) layerSets;
- (SBElementArray<PhotoshopPathItem *> *) pathItems;
...
@property (copy, readonly) NSArray<PhotoshopChannel *> *componentChannels;  // all color component channels for this document
@property (copy) NSArray<PhotoshopChannel *> *currentChannels;  // selected channels for document
...
@property (copy, readonly) NSArray<NSNumber *> *histogram;  // a histogram of values for the composite document (only for RGB, CMYK and 'Indexed colors' documents)
...
- (void) recordMeasurementsSource:(PhotoshopME00)source dataPoints:(NSArray<NSString *> *)dataPoints;  // record measurements of document
...
- (void) selectRegion:(NSArray<id> *)region combinationType:(PhotoshopE630)combinationType featherAmount:(double)featherAmount antialiasing:(BOOL)antialiasing;  // change the selection
- (void) selectAll;  // select the entire image
- (NSArray<PhotoshopDocument *> *) splitChannels;  // split channels of the document
...
@interface PhotoshopBatchOptions : SBObject <PhotoshopGenericMethods>
...
@property (copy) NSArray<NSAppleEventDescriptor *> *fileNaming;  // list of file naming options 6 max.
...
@interface PhotoshopChangeModeOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopChannel : SBObject <PhotoshopGenericMethods>
...
@property (copy, readonly) NSArray<NSNumber *> *histogram;  // a histogram of values for the channel
...
@interface PhotoshopColorSampler : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopContactSheetOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopCountItem : SBObject <PhotoshopGenericMethods>
...
// An installed font
@interface PhotoshopFont : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGalleryBannerOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGalleryColorOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGalleryImagesOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGalleryOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGallerySecurityOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopGalleryThumbnailOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopHistoryState : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopInfoObject : SBObject <PhotoshopGenericMethods>
...
// A layer object
@interface PhotoshopLayer : SBObject <PhotoshopGenericMethods>
...
@property (copy, readonly) NSArray<PhotoshopLayer *> *linkedLayers;
...
@interface PhotoshopLayerComp : SBObject <PhotoshopGenericMethods>
...
@property (copy) NSDictionary *properties;  // all of this object's properties returned in a single record
@property (copy) NSArray<PhotoshopChannel *> *enabledChannels;  // channels that are enabled for the layer set. Must be a list of component channels


@end

// Document Measurement Scale
@interface PhotoshopMeasurementScale : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopPicturePackageOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopPresentationOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopSelectionObject : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopSettingsObject : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopTextObject : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopXMPMetadata : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopOpenOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopSaveOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopExportOptions : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopFilterOptions : SBObject <PhotoshopGenericMethods>
...
@property (copy) NSArray<NSNumber *> *characteristics;  // filter characteristics (array of 25 values - Correspons to a left to right, top to bottom traversal of array presented in the Ui)
...
@property (copy) NSArray *blurCenter;  // position (unit value)
...
@property (copy) NSArray<id> *curve;  // specification of shear curve. List of curve points
@property PhotoshopE715 undefinedAreas;
...
@interface PhotoshopAdjustmentOptions : SBObject <PhotoshopGenericMethods>
...
@property (copy) NSArray<NSNumber *> *shadows;  // list of adjustments for shadows. There must be 3 values in the list
@property (copy) NSArray<NSNumber *> *midtones;  // list of adjustments for midtones. There must be 3 values in the list
@property (copy) NSArray<NSNumber *> *highlights;  // list of adjustments for highlights. There must be 3 values in the list
...
@property (copy) NSArray<NSArray *> *curvePoints;  // list of curve points (number of points must be between 2 and 14)
...
@property (copy) NSArray<id> *outputChannels;  // list of channel specifications. For each component channel that the document has, you must specify a list of adjustment values followed by a 'constant' value
...
@property (copy) NSArray<NSNumber *> *reds;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *yellows;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *greens;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *cyans;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *blues;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *magentas;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *whites;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *neutrals;  // Array of 4 values: cyan, magenta, yellow, black
@property (copy) NSArray<NSNumber *> *blacks;  // Array of 4 values: cyan, magenta, yellow, black
...
// A color value
@interface PhotoshopColorValue : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopPathItem : SBObject <PhotoshopGenericMethods>

- (SBElementArray<PhotoshopSubPathItem *> *) subPathItems;
...
@property (copy) NSDictionary *properties;  // all of this object's properties returned in a single record
@property (copy, readonly) SBObject *container;  // the object's container
@property (copy, readonly) NSArray<PhotoshopSubPathInfo *> *entirePath;  // all the path item's sub paths
...
// A point on a path
@interface PhotoshopPathPoint : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopPathPointInfo : SBObject <PhotoshopGenericMethods>
...
@interface PhotoshopSubPathInfo : SBObject <PhotoshopGenericMethods>

@property BOOL closed;  // is this path closed?
@property (copy) NSArray<PhotoshopPathPointInfo *> *entireSubPath;  // all the sub path item's path points
...
@interface PhotoshopSubPathItem : SBObject <PhotoshopGenericMethods>

- (SBElementArray<PhotoshopPathPoint *> *) pathPoints;
...
@property (copy, readonly) SBObject *container;  // the object's container
@property (copy, readonly) NSArray<PhotoshopPathPointInfo *> *entireSubPath;  // all the sub path item's path points
...
@interface PhotoshopNotifier : SBObject <PhotoshopGenericMethods>
