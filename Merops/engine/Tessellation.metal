...
kernel
void tessellationFactorsCompute(constant float2 &factor                             [[buffer(0)]],
...
[[patch(triangle, 3)]]
vertex
VertexOut tessellationTriangleVertex(PatchIn patchIn                                [[stage_in]],
...
[[patch(triangle, 3)]]
vertex
VertexOut displacementTriangleVertex(PatchIn patchIn [[stage_in]],
                                     constant VertexUniforms &uniforms [[buffer(1)]],
                                     constant TessellationUniforms &tessellation [[buffer(2)]],
                                     float3 patchCoord [[position_in_patch]],
